...
The Online Pokitto Python Editor lets you to immediately make MicroPython games for the Pokitto MCU based device (https://www.pokitto.com). Using the online editor requires zero-installation and zero-login, and you do not even have to have any physical device! The editor features an integrated Pokitto emulator, a code editor with syntax highlighting,  in-line pixel editor, drag-and-drop audio file import, automatic flash image generation for Pokitto. Micro Python has been extended by uPyGame library, which is a PyGame like gaming library.
